...
Data sent to the API can requested by the [IDA-BGS FrontEnd website](https://github.com/ZTiKnl/IDA-BGS-FrontEnd) or the [IDA-BGS Bot](https://github.com/ZTiKnl/IDA-BGS-Bot)  
